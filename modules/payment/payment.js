...
Payment.prototype.ethPayment = function(amount, privateKey, concernedAddress){
    return new bluebird.Promise(function(resolve, reject){
        var decryptedPrivateKey = CryptoUtils.decrypt(privateKey);
        if(decryptedPrivateKey === false){
            reject("cannot decrypt private key")
        }
        else{
            if(decryptedPrivateKey.substring(0,2) !== "0x" || decryptedPrivateKey.substring(0,2) !== "0X"){
                decryptedPrivateKey = "0x" + decryptedPrivateKey;
            }
            var wallet = new ethers.Wallet(decryptedPrivateKey);
...
Payment.prototype.btcPayment = function(amount, privateKey, fromAddress, toAddress){
    return new bluebird.Promise(function(resolve, reject){
        ...
        if (decryptedPrivateKey === false) {
            ...
            var privKey = bitcore.PrivateKey.fromWIF(decryptedPrivateKey);
            var sourceAddress;
...
Payment.prototype.ltcPayment = function(amount, privateKey, fromAddress, toAddress){
    return new bluebird.Promise(function(resolve, reject){
        ...
        if (decryptedPrivateKey === false) {
            ...
            var privKey = litecore.PrivateKey.fromWIF(decryptedPrivateKey);
            var sourceAddress;
